...
<div class="w-full px-10 py-4 flex flex-col items-center bg-layer">
  <div class="flex flex-col justify-center w-[1024px] px-10">
    ...
    <div class="flex justify-center pb-4">
      ...
      <div class="relative ml-[25px]">
        <div class="absolute z-50 inset-y-0 left-0 pl-3
                    flex items-center
                    pointer-events-none">
          <img class="fas fa-envelope text-gray-400" src="@/assets/img/search.svg" alt=""/>
        </div>
    ...
    <div class="flex justify-between">
      <div class="flex items-center font-semibold text-xl leading-5">
  ...
  <Dialog ref="dialogTarget">
    ...
    <form method="dialog">
      что то
      <AppButton :is-add="true" img-name="fileAdd" text="Добавить"/>
    </form>
