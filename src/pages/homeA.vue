...
<template>
  <div class="w-full">
    <HomeHeader
        ...
        @add-book="showDialog"
    />
    <div class="relative max-w-full overflow-y-auto w-full mt-4 desktop:px-12 tablet:px-12 px-4
    desktop:mb-4 tablet:mb-4 mobile:mb-14 mb-14 flex flex-col items-center"
    >
